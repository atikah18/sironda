...
<div class="container-fluid px-4">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <div class="mb-3 row">
               ...
               <!-- <select class="form-control select2" style="width: 100%;" name="task_id" id="task_id" >
                         ...
                         <input type="hidden" id="task_id" name="task_id" value="{{ $data->id }}">
                </div>
            </div>
            <div class="mb-3 row">
    ...
    <div class="mb-3 row">
        <label  for="catatan_monitoring" class="col-sm-2 col-form-label">Catatan Monitoring</label>
        <textarea name="catatan_monitoring" id="catatan_monitoring" class="form-control" rows="6" required></textarea>
        @error('catatan_monitoring') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
