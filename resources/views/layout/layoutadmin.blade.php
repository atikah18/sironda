...
<link href="https://cdn.jsdelivr.net/gh/StartBootstrap/startbootstrap-sb-admin-2@master/css/sb-admin-2.min.css" rel="stylesheet">
    ...
    <body class="sb-nav">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary bg-gradient">
            ...
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3 " href="{{ url('dash') }}">SIMFONI  <span class="badge badge-dark">1.0</span></a>
           
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-10 me-lg-0" id="sidebarToggle" href="#!"><i class="fa-solid fa-bars"></i></button>
            <!-- Navbar-->
             <span class="text-white">Sistem Informasi Formasi Jabatan Terkini BPS se-Provinsi Banten</span>
            ...
            <ul class="navbar-nav ">
                <li class="nav-item dropdown">
                    ...
                    @endif
                    @if ($user==null)
                    <li><a class="dropdown-item" href="{{ url('/simfoni/admin') }}">Login Admin</a></li>
                    @endif
                    </ul>
                </li>
            </ul>
